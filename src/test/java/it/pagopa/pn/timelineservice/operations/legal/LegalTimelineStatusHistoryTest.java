...
class LegalTimelineStatusHistoryTest {
    ...
    void getTimelineHistoryTest() {
        ...
        List<NotificationStatusHistoryElementInt> actualStatusHistory = legalTimelineStatusHistory.getStatusHistory(
...
//        //  ... 1st initial status
    ...
    void getTimelineHistoryMoreRecipientTest() {
        ...
        List<NotificationStatusHistoryElementInt> resHistoryElementList = legalTimelineStatusHistory.getStatusHistory(
                timelineElementList, 1,
                notificationCreatedAt
        );
