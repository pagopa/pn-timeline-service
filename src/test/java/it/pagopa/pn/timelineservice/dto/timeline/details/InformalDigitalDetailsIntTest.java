...
import it.pagopa.pn.timelineservice.dto.timeline.details.informal.SendDigitalMessageSkipDetailsInt;
...
class InformalDigitalDetailsIntTest {
    ...
    void sendDigitalMessageProgressToLogAndTimestamp() {
        ...
        Assertions.assertEquals(eventTimestamp, details.getElementTimestamp());
    }
