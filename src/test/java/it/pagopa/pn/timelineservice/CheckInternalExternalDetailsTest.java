...
class CheckInternalExternalDetailsTest {
    ...
    static Stream<Pair> classPairsProvider() {
        return Stream.of(
            ...
            new Pair(WorkflowDoneReachedDetailsInt.class, WorkflowDoneReachedDetails.class),
            new Pair(WorkflowDoneUnreachedDetailsInt.class, WorkflowDoneUnreachedDetails.class),
