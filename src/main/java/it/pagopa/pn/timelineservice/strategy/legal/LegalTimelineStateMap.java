...
public class LegalTimelineStateMap extends AbstractStateMap {
    ...
    protected void configureTransitions() {
        ...
        this.fromState(NotificationStatusInt.IN_VALIDATION)
                ...
                .withTimelineGoToState(TimelineElementCategoryInt.NOTIFICATION_COST_VALIDATION_REQUEST, NotificationStatusInt.IN_VALIDATION, SINGLE_RECIPINET)
                .withTimelineGoToState(TimelineElementCategoryInt.NOTIFICATION_COST_VALIDATION_RESPONSE, NotificationStatusInt.IN_VALIDATION, SINGLE_RECIPINET)
        ...
        this.fromState(NotificationStatusInt.DELIVERING)
                ...
                .withTimelineGoToState(TimelineElementCategoryInt.ANALOG_FAILURE_WORKFLOW_TIMEOUT, NotificationStatusInt.DELIVERING, SINGLE_RECIPINET)
                .withTimelineGoToState(TimelineElementCategoryInt.NOTIFICATION_TIMELINE_REWORKED, NotificationStatusInt.DELIVERING, SINGLE_RECIPINET)
        ...
        this.fromState(NotificationStatusInt.DELIVERED)
                ...
                .withTimelineGoToState(TimelineElementCategoryInt.NOTIFICATION_TIMELINE_REWORKED, NotificationStatusInt.DELIVERED, SINGLE_RECIPINET)
        ...
        this.fromState(NotificationStatusInt.EFFECTIVE_DATE)
                ...
                .withTimelineGoToState(TimelineElementCategoryInt.NOTIFICATION_TIMELINE_REWORKED, NotificationStatusInt.EFFECTIVE_DATE, SINGLE_RECIPINET)
        ...
        this.fromState(NotificationStatusInt.VIEWED)
                ...
                .withTimelineGoToState(TimelineElementCategoryInt.NOTIFICATION_TIMELINE_REWORKED, NotificationStatusInt.VIEWED, SINGLE_RECIPINET)
        ...
        this.fromState(NotificationStatusInt.UNREACHABLE)
                ...
                .withTimelineGoToState(TimelineElementCategoryInt.NOTIFICATION_TIMELINE_REWORKED, NotificationStatusInt.UNREACHABLE, SINGLE_RECIPINET)
        ...
        this.fromState(NotificationStatusInt.PAID)
                ...
                .withTimelineGoToState(TimelineElementCategoryInt.NOTIFICATION_TIMELINE_REWORKED, NotificationStatusInt.PAID, SINGLE_RECIPINET)
        ...
        this.fromState(NotificationStatusInt.CANCELLED)
                ...
                .withTimelineGoToState(TimelineElementCategoryInt.NOTIFICATION_TIMELINE_REWORKED, NotificationStatusInt.CANCELLED, SINGLE_RECIPINET)
