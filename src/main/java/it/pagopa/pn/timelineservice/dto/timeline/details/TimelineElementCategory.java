...
public enum TimelineElementCategory {
        ...
        TimelineElementCategory(String value) {
        this.value = value;
    }
        ...
        @JsonCreator public static TimelineElementCategory fromValue (String value){
        for (TimelineElementCategory b : TimelineElementCategory.values()) {
