...
public enum TimelineElementCategoryV26 {
        ...
        TimelineElementCategoryV26(String value) {
        this.value = value;
    }
        ...
        @JsonCreator public static TimelineElementCategoryV26 fromValue (String value){
        for (TimelineElementCategoryV26 b : TimelineElementCategoryV26.values()) {
