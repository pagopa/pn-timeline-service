...
import it.pagopa.pn.timelineservice.dto.ext.notification.NotificationPaymentInfoInt;
...
import it.pagopa.pn.timelineservice.generated.openapi.msclient.delivery.model.NotificationRecipientV23;
import org.jetbrains.annotations.NotNull;
import org.springframework.util.CollectionUtils;

import java.util.List;

import static it.pagopa.pn.timelineservice.service.mapper.PaymentMapper.getNotificationPaymentInfo;
import static it.pagopa.pn.timelineservice.service.mapper.PaymentMapper.getNotificationPaymentItem;
...
public class RecipientMapper {
    ...
    public static NotificationRecipientInt externalToInternal(NotificationRecipientV23 recipient) {
        ...
        it.pagopa.pn.timelineservice.generated.openapi.msclient.delivery.model.NotificationDigitalAddress digitalDomicile = recipient.getDigitalDomicile();
