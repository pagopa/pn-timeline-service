...
public class TimelineElementMapper {
    ...
    public TimelineElementInternal externalToInternal(TimelineElement timelineElement ) {
        ...
        return TimelineElementInternal.builder()
                ...
                .reworkRequestType(Optional.ofNullable(timelineElement.getReworkRequestType())
                        .map(reworkRequestTypeEnum -> ReworkRequestTypeEnum.valueOf(reworkRequestTypeEnum.name()))
                        .orElse(null))
